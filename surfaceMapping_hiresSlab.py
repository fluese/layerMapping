...
# -------------------
# MAKE USE OF ANTsPy
# GIVE FILE FOR MAPPING ONTO SURFACE (right hemisphere missing)
# Make an entry point before the segmentation (like in recon all)
...
# 1.2. Set parameters
# -------------------
# Define path from where data is to be copied into BIDS path
...
# Map specific file or all data in a folder onto surface. Requries full path
# to a NIfTI file or folder containing NIfTI files.
map_data = '/tmp/luesebrink/sub-wtl/sub-wtl_run-01_T1map.nii.gz'

# NOT NEEDED CURRENTLY, AS I'M USING MULTIPLE SCRIPTS FOR DIFFERENT PURPOSES
# Flag to process high resolution slab. Slab will be registered to whole
# brain data, merged and used for further processing.
process_hires_slab = True
...
###########################################################################
# 12. Profile sampling of additional data of all layers and mapping it onto
